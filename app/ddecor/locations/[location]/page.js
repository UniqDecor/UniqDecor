      ...
      <section className="py-20 px-4 md:px-12 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 flex flex-col gap-6">
            <span className="text-xs uppercase tracking-[0.25em] text-[#8B4513] font-bold">Udaipur Flagship Showroom</span>
            ...
            <p className="text-[#6B6560] text-xs md:text-sm leading-relaxed">
              Browse the complete official D'Decor swatch books with our designers. We are a short drive from anywhere in {data.locationName}.
            </p>
