...
export default function LaxreeRoofingPage() {
  ...
  return (
    <div ref={containerRef} className="theme-laxree bg-[#FAF9F5] text-[#1E2022] min-h-screen">
      ...
      {/* ESTIMATES & SITE SURVEY */}
      <section className="bg-[#1E2022] text-white py-20 px-6 md:px-12 relative overflow-hidden border-t-4 border-[#D97706]" id="roofing-consultation">
        <div className="absolute inset-0 roofing-premium-radial-bg pointer-events-none"></div>
        
        <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col gap-6 items-center">
          <span className="text-xs uppercase tracking-[0.3em] text-[#D97706] font-bold">Resort Roofing Consultations</span>
          <h2 className="font-serif text-3xl md:text-5xl font-bold tracking-tight">Request a Site Survey & Roof Estimate</h2>
          <p className="text-white/80 max-w-2xl text-xs md:text-base leading-relaxed">
            Constructing a luxury villa, hill resort, or high-pitch roof? Request a technical architectural site survey in Udaipur by our team to get CAD estimates and tile counts.
          </p>
          
          <div className="mt-8 flex flex-col sm:flex-row gap-4 w-full justify-center">
            <a 
              href="https://wa.me/919982219222?text=Hi%20Uniq%20Decor!%20👋%20I%20am%20interested%20in%20LaxRee%20Premium%20Roofing%20tiles%20and%20shingles.%20Please%20schedule%20a%20site%20survey%20for%20our%20project." 
              target="_blank" 
            ...
            <Link 
              href="/#showroom" 
              className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-transparent border border-white hover:bg-white hover:text-[#1E2022] text-white text-xs uppercase tracking-widest font-bold rounded-full transition-all duration-300 cursor-hover font-sans"
            >
